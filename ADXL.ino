...
// WiFi AP SSID
#define WIFI_SSID "For Study Only"
// WiFi password
#define WIFI_PASSWORD "leduyhieu"
// InfluxDB v2 server url, e.g. https://eu-central-1-1.aws.cloud2.influxdata.com (Use: InfluxDB UI -> Load Data -> Client Libraries)
#define INFLUXDB_URL "https://europe-west1-1.gcp.cloud2.influxdata.com"
// InfluxDB v2 server or cloud API authentication token (Use: InfluxDB UI -> Load Data -> Tokens -> <select token>)
#define INFLUXDB_TOKEN "_uWtjo9mrorJF1wlJVR7YFWSjmJuoP0VcyLzGK-RyJkn5Sj_HtLVkyclm0Q6EocoRkFbjm2NRbYWOLGxm3d1sA=="
// InfluxDB v2 organization id (Use: InfluxDB UI -> Settings -> Profile -> <name under tile> )
#define INFLUXDB_ORG "hieungoanngoan@gmail.com"
